...
MainLayer.prototype.initTitle = function(){
    this._scoreLb = ccui.ImageView.create();
    this._scoreLb.loadTexture("score.png",ccui.Widget.PLIST_TEXTURE);
    this._scoreLb.setPosition(cc.p(200,1020));
    this.addChild(this._scoreLb);

    var curScore = ccui.Text.create();
    curScore.setFontSize(40);
    curScore.setPosition(cc.p(0,-15));
    curScore.setText("0");
    curScore.setName("num");
    this._scoreLb.addChild(curScore);

    this._hightScoreLb = ccui.ImageView.create();
    this._hightScoreLb.loadTexture("high_ccore.png",ccui.Widget.PLIST_TEXTURE);
    this._hightScoreLb.setPosition(cc.p(500,1020));
    this.addChild(this._hightScoreLb);

    var score2 = ccui.Text.create();
    score2.setFontSize(40);
    score2.setPosition(cc.p(0,-15));
    score2.setText("0");
    score2.setName("num");
    this._hightScoreLb.addChild(score2);
};

MainLayer.prototype.addScore = function(score){

    this._score += score;
    this._scoreLb.getChildByName("num").setText(this._score);

    if(this._score>this._highScore){
        this._highScore = this._score;
        this._hightScoreLb.getChildByName("num").setText(this._highScore);
    }
};
...
MainLayer.prototype.combine =function(direct){
    ...
    this.runAction(
        cc.Sequence.create(
            ...
            cc.CallFunc.create(this.newNumber.bind(this),this)
        )
    );
};
